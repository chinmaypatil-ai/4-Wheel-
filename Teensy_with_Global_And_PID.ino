...
void loop() {
  ...
  V1 = w * r + (Vgy / 1.41421356237) + (Vgx / 1.41421356237);
  V2 = w * r + (Vgx / 1.41421356237) - (Vgy / 1.41421356237);
  V3 = w * r - (Vgx / 1.41421356237) - (Vgy / 1.41421356237);
  V4 = w * r + (Vgy / 1.41421356237) - (Vgx / 1.41421356237);
